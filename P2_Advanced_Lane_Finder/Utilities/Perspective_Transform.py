...
class Perspective_Transform:
    ...
    def process(self):
        Perspective_Transform.undistort = staticmethod(Perspective_Transform.undistort)
        ...
        undistorted = Perspective_Transform.undistort(self.image)
        warped, warped_labelled, roi, image_labelled = Perspective_Transform.perspective_transform(undistorted)
